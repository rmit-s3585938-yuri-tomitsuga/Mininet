...
public class PersonViewController {
    ...
    private void handleNewPerson() {
        ...
        boolean okClicked = miniNet.showPersonEditDialog(tempPerson);
        if (okClicked) {
            miniNet.getPersonData().add(tempPerson);
        }
    }
    ...
    private void handleEditPerson() {
        ...
        if (selectedPerson != null) {
            boolean okClicked = miniNet.showPersonEditDialog(selectedPerson);
            if (okClicked) {
